...
NoNo：普通使用充电工作、惊讶等待、生气悬停；超能使用魔方工作、惊讶等待、生气悬停；至尊保留召唤后半段工作和轻微皱眉等待，惊讶用于悬停。普通和至尊的检查状态使用高兴；超能检查使用召唤旋转，打招呼按选择使用生气片段。
...
| nono | jumping | super-exp-2.swf | 14, 18, 22, 26, 30 |
